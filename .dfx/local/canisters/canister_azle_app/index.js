...
import { idlFactory } from './canister_azle_app.did.js';
export { idlFactory } from './canister_azle_app.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_AZLE_APP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canister_azle_app.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canister_azle_app canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canister_azle_app.did.js")._SERVICE>}
 */
export const canister_azle_app = createActor(canisterId);
